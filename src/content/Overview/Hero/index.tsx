  ...
  return (
    ...
    >
      ...
      <Container sx={{ position: 'relative', zIndex: 1 }}>
        ...
        <Box
          component="img"
          src="/static/images/overview/star.svg"
          alt="Star"
          sx={{
            position: 'absolute',
            top: -40,
        ...
        <Box
          component="img"
          src="/static/images/overview/lineone.svg"
          alt="Line"
          sx={{
            position: 'absolute',
            top: 60,
        ...
        <Box
          component="img"
          src="/static/images/overview/linetwo.svg"
          alt="Bottom"
          sx={{
            position: 'absolute',
            bottom: -40,
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <StyledButton variant="contained" color="success" href="/login">
                    Login as User
                  </StyledButton>
                </Box>
              </motion.div>
